...
**External LLM (Opus) + toolchain** — powerful cloud models are **orchestrators**, not postfix compilers; IR → transpiler → gforth. Hub: [`docs/AI-KNOWLEDGE-INDEX.md`](docs/AI-KNOWLEDGE-INDEX.md). See also [`docs/EXTERNAL-LLM-ARCHITECTURE.md`](docs/EXTERNAL-LLM-ARCHITECTURE.md), [`docs/AI-VS-TOOLS.md`](docs/AI-VS-TOOLS.md), [`docs/ROADMAP-AI-PLATFORM.md`](docs/ROADMAP-AI-PLATFORM.md).
