...
<span id="Floating-Point-Tutorial"></span>

<div class="header">

Next: [Files Tutorial](Files-Tutorial.html#Files-Tutorial), Previous: [Alignment Tutorial](Alignment-Tutorial.html#Alignment-Tutorial), Up: [Tutorial](Tutorial.html#Tutorial)   \[[Contents](index.html#SEC_Contents "Table of contents")\]\[[Index](Word-Index.html#Word-Index "Index")\]

</div>

-----

<span id="Floating-Point-1"></span>

### 3.26 Floating Point

<span id="index-floating-point-tutorial"></span> <span id="index-FP-tutorial"></span>
...
> **Assignment:** Write a program to solve a quadratic equation. Then read Henry G. Baker, [You Could Learn a Lot from a Quadratic](http://home.pipeline.com/~hbaker1/sigplannotices/sigcol05.ps.gz), ACM SIGPLAN Notices, 33(1):30-39, January 1998, and see if you can improve your program. Finally, find a test case where the original and the improved version produce different results.

Reference: [Floating Point](Floating-Point.html#Floating-Point); [Floating point stack](Floating-point-stack.html#Floating-point-stack); [Number Conversion](Number-Conversion.html#Number-Conversion); [Memory Access](Memory-Access.html#Memory-Access); [Address arithmetic](Address-arithmetic.html#Address-arithmetic).
