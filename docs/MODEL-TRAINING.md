...
3. Опционально: chunk из `sources/brodie-thinking-forth/*.md`, `sources/gforth-manual-tutorial/*.md`, или фрагмент из `sources/theforth.net-packages/` + промпт «напиши Gforth-пример к идиоме».
