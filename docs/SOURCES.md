...
| `forth-dialect-gforth.mdc` | Gforth manual (`sources/gforth-manual/`); Gforth Tutorial §3.1, §3.2, §3.15, §3.30, §3.10 | seed + distilled |
...
| `sources/gforth-manual/*.md` | Gforth manual полностью (GNU GPL), https://gforth.org/manual/, `extract.sh` | vendored; справочник слов / окружение / conformance |
