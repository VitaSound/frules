...
You MAY read and reuse examples from anywhere in the repo: sources/ (theforth.net-packages, brodie-thinking-forth, …), data/challenge-solutions/, tests/ans/, tests/gforth/, examples/, similar challenges, Source URL. Prefer inlining adapted idioms in the paste zone over fragile includes.
...
- [ ] Used `sources/` examples and `rules/` / `AGENTS.md`
