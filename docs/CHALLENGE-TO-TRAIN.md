...
- You MAY read and reuse tests/ans/, tests/gforth/, examples/, data/challenge-solutions/, sources/theforth.net-packages/, sources/brodie-thinking-forth/, sources/gforth-manual-tutorial/, similar .fs files.
